        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              `connect-src 'self'${isDev ? " http://localhost:9000" : ""} https://*.google-analytics.com https://*.analytics.google.com https://*.facebook.com https://api.resend.com https://graph.facebook.com https://*.meilisearch.com https://challenges.cloudflare.com https://o4511107177250816.ingest.us.sentry.io https://secure.nmi.com https://secure.networkmerchants.com https://*.sanity.io https://*.r2.dev https://*.r2.cloudflarestorage.com`,
