    ...
    >
      <Popover className="relative h-full">
        ...
        >
          <PopoverPanel
            static
            className="hidden small:block absolute top-[calc(100%+1px)] right-0 bg-white border-x border-b border-ergo-200 w-[420px] text-ui-fg-base"
            ...
            {cartState && cartState.items?.length ? (
              ...
              <div>
                <div className="flex py-16 flex-col gap-y-4 items-center justify-center">
                  <div className="bg-ergo-950 text-small-regular flex items-center justify-center w-6 h-6 rounded-full text-white">
                    <span>0</span>
                  </div>
                  ...
                  <div>
                    <LocalizedClientLink href="/store">
                      <>
                        <span className="sr-only">{t.store.all_products}</span>
                        <Button onClick={close}>{t.store.all_products}</Button>
                      </>
                    </LocalizedClientLink>
                  </div>
                </div>
