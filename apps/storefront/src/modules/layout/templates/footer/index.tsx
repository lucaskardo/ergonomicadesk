          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2 text-[0.8rem]">
              <div className="flex items-start gap-2" style={{ color: "rgba(255,255,255,0.4)" }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="mt-0.5 flex-shrink-0 text-ergo-sky">
              ...
              <div className="flex items-center gap-2" style={{ color: "rgba(255,255,255,0.4)" }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="flex-shrink-0 text-ergo-sky">
