    ...
    <>
      <div className="flex flex-col gap-4" ref={actionsRef}>
        ...
        <Button
          ...
          className={`w-full h-14 font-semibold text-[0.92rem] tracking-[0.01em] transition-colors text-white border-none flex items-center justify-center gap-2 ${added ? "bg-ergo-success" : "bg-ergo-sky-dark hover:bg-ergo-sky"}`}
        ...
        <a
          ...
          className="w-full h-12 flex items-center justify-center gap-2 font-semibold text-[0.85rem] text-white transition-all duration-300 bg-whatsapp hover:bg-whatsapp-hover"
        >
