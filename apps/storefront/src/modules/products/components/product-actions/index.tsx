    ...
    try {
      ...
      if (extendedWarranty) {
        try {
          ...
          let warrantySku = "extended-warranty-accessories"
          ...
          } else if (catHandles.some((h: string) => h.includes("storage") || h.includes("almacen") || h.includes("cabinet"))) {
          ...
          // Non-blocking — main product was already added
        }
      }
    ...
    <>
      <div className="flex flex-col gap-4" ref={actionsRef}>
        ...
        <Button
          ...
          className={`w-full h-14 font-semibold text-[0.92rem] tracking-[0.01em] transition-colors duration-fast ease-out-soft text-white border-none flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed ${added ? "bg-ergo-success" : "bg-ergo-sky-dark hover:bg-ergo-sky"}`}
        ...
        <a
          ...
          className="w-full h-12 flex items-center justify-center gap-2 font-semibold text-[0.85rem] text-white transition duration-base bg-whatsapp hover:bg-whatsapp-hover"
        >
