      ...
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-11 items-center">
          ...
          <div className="relative aspect-[4/3] overflow-hidden">
            <div className="w-full h-full bg-gradient-to-br from-ergo-100 to-ergo-200" />
            {/* Badge */}
            <div
            ...
            >
              <span className="text-ergo-sky-dark">
                <MapPinIcon />
              </span>
              {c.badge}
            </div>
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-2.5">
              <div className="flex items-center gap-2.5 text-[0.83rem] text-ergo-400">
                <span className="text-ergo-sky-dark"><MapPinIcon /></span>
                {c.address}
              </div>
              <div className="flex items-center gap-2.5 text-[0.83rem] text-ergo-400">
                <span className="text-ergo-sky-dark"><ClockIcon /></span>
                {c.hours}
              </div>
              <div className="flex items-center gap-2.5 text-[0.83rem] text-ergo-400">
                <span className="text-ergo-sky-dark"><PhoneIcon /></span>
                {c.phone}
              </div>
            </div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 mt-6 px-7 py-3.5 text-white font-semibold text-[0.84rem] transition-all duration-300 hover:-translate-y-0.5 bg-whatsapp hover:bg-whatsapp-hover"
            >
