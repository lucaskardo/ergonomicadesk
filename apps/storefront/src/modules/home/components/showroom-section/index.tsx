        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-11 items-center">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 mt-6 px-7 py-3.5 text-white font-semibold text-[0.84rem] transition duration-base hover:-translate-y-0.5 bg-whatsapp hover:bg-whatsapp-hover"
            >
