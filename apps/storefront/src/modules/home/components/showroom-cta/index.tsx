          ...
          <div className="bg-white border border-ergo-200/60 p-10 flex flex-col justify-center gap-6">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 font-semibold text-[0.84rem] text-white transition-all duration-300 hover:-translate-y-0.5 bg-whatsapp hover:bg-whatsapp-hover"
              >
