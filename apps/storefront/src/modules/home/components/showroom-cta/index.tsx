      ...
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          ...
          <div
            ...
            style={{ minHeight: 320, background: "linear-gradient(145deg, #D0D7E3 0%, #A5B1C7 100%)" }}
          >
            <iframe
          ...
          <div className="bg-white border border-ergo-200/60 p-10 flex flex-col justify-center gap-6">
            ...
            <div className="flex flex-col gap-2 text-[0.84rem]">
              <div className="flex items-start gap-2.5 text-ergo-600">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#2A8BBF" strokeWidth="1.8" className="mt-0.5 flex-shrink-0">
              ...
              <div className="flex items-center gap-2.5 text-ergo-600">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#2A8BBF" strokeWidth="1.8">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 font-semibold text-[0.84rem] text-white transition-all duration-300 hover:-translate-y-0.5"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3.5 border-[1.5px] border-ergo-200 text-ergo-800 font-semibold text-[0.84rem] hover:border-ergo-950 transition-all duration-300"
              >
                {c.mapsLabel}
              </a>
            </div>
