  ...
  return (
    ...
    >
      <div className="relative flex items-center">
        {/* Tooltip */}
        <span className="absolute right-14 bg-ergo-950 text-white text-xs px-3 py-1.5 rounded-full whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-fast pointer-events-none">
          {tooltip}
        </span>
        {/* Button */}
        <div className="w-14 h-14 bg-whatsapp rounded-full shadow-medium flex items-center justify-center hover:scale-110 hover:shadow-elevated transition duration-fast ease-out-soft">
          <svg
